...
router.get('/', function (req, res) {
           ...
           var lang = require("../public/playdrawingconfig/lang/playdrawingconfig_cn.json");
           }
           else{
           var lang = require("../public/playdrawingconfig/lang/playdrawingconfig_en.json");
           }
           resource.lang = lang;
...
router.get('/getdata', function(req, res){
           ...
           PlaydrawingProject.findOne({ '_id': _id }, function (err, project) {
                                    if (err){
                                    res.json(err);
                                    return next(err);
                                    }
