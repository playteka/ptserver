...
var playdrawingconfig = require('./routes/playdrawingconfig.js');
...
app.use(session({store: new redisStore(), secret: 'zhouhuanyu', cookie: { maxAge: 3600*1000 }, rolling:true}));
app.use(logger('dev'));
...
app.use('/playdrawingconfig', playdrawingconfig);
